...
public abstract class BaseOrganizationHierarchyFunction implements OrganizationFunction {
	...
	protected static final Map<Long, Long> ACTOR_CODE_ACTOR_ACTOR_ID_CACHE_MAP = new HashMap<Long, Long>();

	protected static final TTLMapCleaner ACTOR_CODE_ACTOR_ACTOR_ID_CLEANER = new TTLMapCleaner(ACTOR_CODE_ACTOR_ACTOR_ID_CACHE_MAP);
