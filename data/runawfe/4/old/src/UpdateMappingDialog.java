...
private String type;
	...
	protected UpdateMappingDialog(Shell parentShell) {
		super(parentShell);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		labelTitle.setText(Messages.getString("Mapping.update.message"));
		...
		typeField = new Text(composite, SWT.BORDER | SWT.READ_ONLY);
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText(Messages.getString("Mapping.update.title"));
	}
