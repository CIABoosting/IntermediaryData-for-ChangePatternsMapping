...
import org.jbpm.ui.properties.BSHPropertyDescriptor;
...
public class Decision extends DescribableNode implements InternalState, Delegable, Active {
	...
	private static final IPropertyDescriptor NAME_DESCRIPTOR = new TextPropertyDescriptor(PROPERTY_NAME, Messages.getString("Decision.property.name"));
	private static final IPropertyDescriptor CLASS_DESCRIPTOR = new ClassPropertyDescriptor(PROPERTY_CLASS, Messages.getString("Decision.property.class"), "org.jbpm.delegation.DecisionHandler"); 
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		return new IPropertyDescriptor[]{
				NAME_DESCRIPTOR, 
				CLASS_DESCRIPTOR,
				new BSHPropertyDescriptor(this, PROPERTY_CONFIGURATION, Messages.getString("Decision.property.configuration"))
				};
	}
